    ...
    public class MockRepository : IRepository
    {
        ...
        public void SeedApril()
        {
            ...
            var assignments = new List<IAssignment>
            {
                ...
                Assignment.Create(Role.Off, EM,new DateTime(2015,4,17)),
                Assignment.Create(Role.Off, LS,new DateTime(2015,4,17)),
                Assignment.Create(Role.Off, YS,new DateTime(2015,4,17)),
                Assignment.Create(Role.Off, JT,new DateTime(2015,4,17)),
